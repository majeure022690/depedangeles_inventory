 ...
 * Backend owns: `belongsTo` wiring on Personnel (`sdo_office_id`), Form
 * Request validation, and any admin CRUD for managing these rows (Step 2).
 */
#[Fillable(['name', 'description', 'sort_order', 'is_active'])]
class SdoOffice extends Model
{
