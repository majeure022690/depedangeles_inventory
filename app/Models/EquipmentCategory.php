 ...
 * Backend owns: `belongsTo` wiring on Equipment (`equipment_category_id`),
 * Form Request validation, reworking Equipment::scopeCategory to filter by
 * id, and any admin CRUD for managing these rows (Step 2).
 */
