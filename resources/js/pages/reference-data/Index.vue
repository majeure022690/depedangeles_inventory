...
<template>
    ...
    <div class="flex flex-col gap-8 p-4">
        <Heading
            ...
            description="Manage the dropdown options used throughout equipment, personnel, and ISP account forms."
        />

        <section class="space-y-3">
            <div class="flex items-center gap-2">
                <Database class="size-4 text-muted-foreground" />
                <h3 class="text-sm font-medium text-muted-foreground">Standalone lists</h3>
            </div>
        ...
        <section class="space-y-3">
            <div class="flex items-center gap-2">
                ...
                <h3 class="text-sm font-medium text-muted-foreground">Grouped options</h3>
            </div>
            <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                <Link
        ...
        <section v-if="can('office.view')" class="space-y-3 border-t pt-8">
            <div class="flex items-center gap-2">
                ...
                <h3 class="text-sm font-medium text-muted-foreground">Schools & Offices</h3>
            </div>
            <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                <Link
                    :href="offices.index()"
