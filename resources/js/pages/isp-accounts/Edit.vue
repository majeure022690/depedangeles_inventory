...
const form = useForm<IspAccountFormData>({
    ...
    min_speed: props.ispAccount.min_speed !== null ? String(props.ispAccount.min_speed) : '',
    max_speed: props.ispAccount.max_speed !== null ? String(props.ispAccount.max_speed) : '',
